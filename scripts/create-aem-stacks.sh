...
create_multi_stacks "apps/author apps/publish apps/publish-dispatcher apps/author-dispatcher"
create_single_stack "apps/orchestrator"
create_multi_stacks "apps/chaos-monkey apps/dns-records"
