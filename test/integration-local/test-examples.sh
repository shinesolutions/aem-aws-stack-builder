...
rm -f examples/user-config/common/zzz-test-integration-local.yaml
...
cd ../aem-aws-stack-builder
(make config-examples-aem63-rhel7-full-set && make delete-full-set "stack_prefix=${test_id}-full-set" config_path=stage/user-config/aem63_sp1_cfp2-rhel7-full-set/) &
(make config-examples-aem63-rhel7-consolidated && make delete-consolidated "stack_prefix=${test_id}-consolidated" config_path=stage/user-config/aem63_sp1_cfp2-rhel7-consolidated/) &
