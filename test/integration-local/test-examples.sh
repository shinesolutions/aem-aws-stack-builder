...
mkdir -p stage/user-config/aem-stack-manager/ && cp examples/user-config/apps/aem-stack-manager.yaml stage/user-config/aem-stack-manager/ && make create-stack-manager "stack_prefix=${test_id}-stack-manager" config_path=stage/user-config/aem-stack-manager/
...
(make delete-stack-manager "stack_prefix=${test_id}-stack-manager" config_path=stage/user-config/aem-stack-manager/) &
wait
