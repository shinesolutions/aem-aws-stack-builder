...
make config-examples-aem62-rhel7-full-set && make create-full-set "stack_prefix=${test_id}-full-set" config_path=stage/user-config/aem62_sp1_cfp13-rhel7-full-set/
make config-examples-aem62-rhel7-consolidated && make create-consolidated "stack_prefix=${test_id}-consolidated" config_path=stage/user-config/aem62_sp1_cfp13-rhel7-consolidated/
...
cd ../aem-aws-stack-builder
make config-examples-aem62-rhel7-full-set && make delete-full-set "stack_prefix=${test_id}-full-set" config_path=stage/user-config/aem62_sp1_cfp13-rhel7-full-set/
make config-examples-aem62-rhel7-consolidated && make delete-consolidated "stack_prefix=${test_id}-consolidated" config_path=stage/user-config/aem62_sp1_cfp13-rhel7-consolidated/
