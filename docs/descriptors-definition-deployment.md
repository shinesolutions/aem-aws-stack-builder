...
| \<component>.packages.sleep_seconds | The number of seconds to wait after installing each AEM package before proceeding with readiness check | Numeric string |
