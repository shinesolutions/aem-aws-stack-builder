...
| aem.deployment_post_install_wait_in_seconds | The number of seconds delay after AEM package installation, before resuming to perform health checks | Optional | 120 |
