...
| stack_manager.purge.live_snapshots.max_age | The number of hours to keep a live snapshot before it expires and will be removed | Optional | `24` |
...
| stack_manager.purge.offline_snapshots.max_age | The number of hours to keep an offline snapshot before it expires and will be removed  | Optional | `61320` |
...
| stack_manager.purge.orchestration_snapshots.max_age | The number of hours to keep an orchestration snapshot before it expires and will be removed  | Optional | `4` |
